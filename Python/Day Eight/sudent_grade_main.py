...
student_averages = calculate_average_score_of_students(total_students_scores)
position_list = get_position_of_students(student_total)
...
average_of_each_subject = calculate_average_score_of_students(all_subjects_list)
...
over_all_average = calculate_average_scores(total_of_subjects)
